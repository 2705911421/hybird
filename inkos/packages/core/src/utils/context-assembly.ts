...
export function isProtectedContextSource(source: string): boolean {
  return source.startsWith("story-runtime/hard_constraints/")
    || source.startsWith("story-runtime/plot_commitments/")
    || source.startsWith("story-runtime/conflict/")
    || source.startsWith("story-runtime/request/hard-")
    || source.startsWith("story-runtime/request/must-not-")
    || source === "story-runtime/request/chapter-goal"
